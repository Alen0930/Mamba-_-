"""
Ensemble GND (EGND) dismantler interface.

Reference:
> Ren, X.-L., Antulov-Fantulin, N. Ensemble approach for generalized network dismantling. Complex Networks VIII, 783–793 (2020). DOI: 10.1007/978-3-030-36687-2_65
"""
