"""
Brute-force dismantler – enumerates all node combinations for small networks.

Reference:
> Exact enumeration method for network dismantling. NP-hard; feasible only for n ≤ 30.
"""
import argparse
